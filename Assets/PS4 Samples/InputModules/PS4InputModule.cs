...
namespace InputModules
{
    ...
    public class PS4InputModule : PointerInputModule
    {
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= Input.GetButtonDown(m_CancelButton + m_AxisNameSuffix);
            shouldActivate |= !Mathf.Approximately(Input.GetAxisRaw(m_HorizontalAxis + m_AxisNameSuffix), 0.0f);
            shouldActivate |= !Mathf.Approximately(Input.GetAxisRaw(m_VerticalAxis + m_AxisNameSuffix), 0.0f);
        ...
        private void ProcessTouchPress(PointerEventData pointerEvent, bool pressed, bool released)
        {
            ...
            if (pressed)
            {
                ...
                DeselectIfSelectionChangedAndValid(currentOverGo, pointerEvent, true);
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            move.x = Input.GetAxisRaw(m_HorizontalAxis + m_AxisNameSuffix);
            move.y = Input.GetAxisRaw(m_VerticalAxis + m_AxisNameSuffix);
        ...
        protected bool SendMoveEventToSelectedObject()
        {
            ...
            if (m_IsRepeating)
            {
                ...
                bool allow = Input.GetButtonDown(m_HorizontalAxis + m_AxisNameSuffix) || Input.GetButtonDown(m_VerticalAxis + m_AxisNameSuffix);
