...
{
	[DllImport("NativePluginPS4Example")]
	...
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 0)]		// i think it's import that the Pack is equal to zero here
